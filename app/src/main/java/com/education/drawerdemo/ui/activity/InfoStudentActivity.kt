...
import com.education.drawerdemo.databinding.GiveStudentInformationLayoutBinding

class InfoStudentActivity : AppCompatActivity() {
    private var binding: GiveStudentInformationLayoutBinding? = null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        //view binding
        binding = GiveStudentInformationLayoutBinding.inflate(layoutInflater)
